        ...
        <div class="w-full grid grid-cols-1 gap-4">
            ...
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 border border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    ...
                    </div> <a href="#" class="px-4 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700"> + Create Profile </a>
                ...
                <div class="text-center py-8">
                    <p class="text-gray-500 mb-4">You don't have any profiles yet.</p> <a href="#" class="inline-block px-6 py-3 bg-brand-600 text-white rounded-lg hover:bg-brand-700"> Create Your First Profile </a>
                </div> @endif
