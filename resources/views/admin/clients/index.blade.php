...
<div class="pt-6">
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-2">Manage all client users in the system</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg p-4 mb-6 border border-gray-200">
        <form method="GET" action="{{ route('admin.clients.index') }}" class="flex gap-4">
            ...
            @if(request()->hasAny(['search', 'role']))
                <a href="{{ route('admin.clients.index') }}" class="px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500">Clear</a>
            @endif
        </form>
    </div>
