<x-admin-layout>
    <div class="pt-6">
        <div class="mb-6">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-2">Add a new package to the system</p>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" required 
                                    ...
                                    <option value="nfc_plain" {{ old('type') === 'nfc_plain' ? 'selected' : '' }}>NFC Plain Card</option>
                                    <option value="nfc_printed" {{ old('type') === 'nfc_printed' ? 'selected' : '' }}>NFC Printed Card</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div id="pricingTiersSection" style="display: none;">
                        ...
                        <div id="pricingTiersContainer">
                            <!-- Pricing tiers will be added dynamically -->
                        </div>
    ...
    <script>
        ...
        let featureCount = {{ old('features') ? count(old('features')) : 0 }};
