...
<head>
    ...
    <title>404 - Page Not Found | {{ config('app.name', 'Linkadi') }}</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        <div class="text-center">
            <div class="mb-8">
                <h1 class="text-9xl font-bold text-brand-600">404</h1>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button onclick="window.history.back()" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 font-medium transition-colors">
                    Go Back
                </button>
            </div>
        </div>
