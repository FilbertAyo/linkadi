...
<div>
    ...
    <div class="mt-8 space-y-4">
        ...
        <button wire:click="logout" 
                type="button" 
                class="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-base px-5 py-3 w-full sm:w-auto text-center">
            {{ __('Log Out') }}
        </button>
    </div>
</div>
