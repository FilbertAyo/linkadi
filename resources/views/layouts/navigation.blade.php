    ...
    <nav class="px-4 py-3 lg:px-6">
        <div class="flex items-center justify-between"> <!-- Page Title / Search Section -->
            ...
            <div class="flex items-center space-x-3">
                ...
                <button id="toggleSidebarMobile" type="button" class="p-2 text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 mr-2" aria-label="Toggle sidebar">
                ...
                <!-- Notifications --> <button type="button" class="relative p-2 text-gray-500 hover:bg-gray-100 rounded-lg"> <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
