<!-- Top Navigation Bar -->
<header class="fixed z-40 top-0 right-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 lg:left-[18rem]">
    <nav class="px-4 py-3 lg:px-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <!-- Notifications -->
                <button type="button" class="relative p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
